...
$.SmartMessageBox = function(settings, callback) {
    ...
    if (settings.input != undefined) {
        ...
        case "text":
            settings.inputValue = $.type(settings.inputValue) === "string"
                ? settings.inputValue.replace(/'/g, "&#x27;")
                : settings.inputValue;
            InputType = "<input class='form-control' type='" +
                settings.input +
                "' id='txt" +
                SmartMSGboxCount +
                "' placeholder='" +
    ...
    Content = "<div class='MessageBoxContainer animated fadeIn fast' id='Msg" +
        SmartMSGboxCount +
        "'>";
...
$.bigBox = function(settings, callback) {
    ...
    $("#divMiniIcons").append("<div id='miniIcon" +
        BigBoxes +
...
$.smallBox = function(settings, callback) {
    ...
    if (settings.iconSmall == undefined) {
        ...
        IconSection = "<div class='miniIcono'><i class='miniPic " +
            settings.iconSmall +
            "'></i></div>";
    }

    if (settings.icon == undefined) {
        BoxSmall = "<div id='smallbox" +
            SmallBoxes +
